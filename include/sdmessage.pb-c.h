...
typedef struct MessageT__Stats MessageT__Stats;
...
struct  MessageT__Stats
{
  ...
  int64_t opput;
  int64_t opgetkeys;
  int64_t optableprint;
  int64_t opdel;
  int64_t opstats;
};
#define MESSAGE_T__STATS__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&message_t__stats__descriptor) \
    , 0, 0, 0, 0, 0, 0, 0, 0, 0 }
...
typedef void (*MessageT__Entry_Closure)
                 (const MessageT__Entry *message,
                  void *closure_data);
typedef void (*MessageT__Stats_Closure)
                 (const MessageT__Stats *message,
                  void *closure_data);
...
extern const ProtobufCMessageDescriptor message_t__stats__descriptor;

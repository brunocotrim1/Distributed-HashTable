...
void   message_t__stats__init
                     (MessageT__Stats         *message)
{
  static const MessageT__Stats init_value = MESSAGE_T__STATS__INIT;
  *message = init_value;
}
...
static const ProtobufCFieldDescriptor message_t__stats__field_descriptors[9] =
{
  {
    "n_requests",
    1,
    ...
    0,   /* quantifier_offset */
    offsetof(MessageT__Stats, n_requests),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    0,   /* quantifier_offset */
    offsetof(MessageT__Stats, currentaverage),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    PROTOBUF_C_TYPE_INT64,
    0,   /* quantifier_offset */
    offsetof(MessageT__Stats, opget),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    PROTOBUF_C_TYPE_INT64,
    0,   /* quantifier_offset */
    offsetof(MessageT__Stats, opsize),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    PROTOBUF_C_TYPE_INT64,
    0,   /* quantifier_offset */
    offsetof(MessageT__Stats, opput),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    PROTOBUF_C_TYPE_INT64,
    0,   /* quantifier_offset */
    offsetof(MessageT__Stats, opgetkeys),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    PROTOBUF_C_TYPE_INT64,
    0,   /* quantifier_offset */
    offsetof(MessageT__Stats, optableprint),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    PROTOBUF_C_TYPE_INT64,
    0,   /* quantifier_offset */
    offsetof(MessageT__Stats, opdel),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    PROTOBUF_C_TYPE_INT64,
    0,   /* quantifier_offset */
    offsetof(MessageT__Stats, opstats),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
...
static const unsigned message_t__stats__field_indices_by_name[] = {
  1,   /* field[1] = currentAverage */
  0,   /* field[0] = n_requests */
  7,   /* field[7] = opDel */
  2,   /* field[2] = opGet */
  5,   /* field[5] = opGetKeys */
  4,   /* field[4] = opPut */
  3,   /* field[3] = opSize */
  8,   /* field[8] = opStats */
  6,   /* field[6] = opTablePrint */
};
static const ProtobufCIntRange message_t__stats__number_ranges[1 + 1] =
{
  { 1, 0 },
  { 0, 9 }
};
const ProtobufCMessageDescriptor message_t__stats__descriptor =
{
  PROTOBUF_C__MESSAGE_DESCRIPTOR_MAGIC,
  "message_t.Stats",
  "Stats",
  "MessageT__Stats",
  "",
  sizeof(MessageT__Stats),
  9,
  message_t__stats__field_descriptors,
  message_t__stats__field_indices_by_name,
  1,  message_t__stats__number_ranges,
  (ProtobufCMessageInit) message_t__stats__init,
  NULL,NULL,NULL    /* reserved[123] */
};
